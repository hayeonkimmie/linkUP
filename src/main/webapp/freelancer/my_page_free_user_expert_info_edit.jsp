        ...
        <section class="section">
            ...
            <form action="${contextPath}/my-page/edit-expert-info" method="post" enctype="multipart/form-data"
                ...
                <div class="form form-group formCertificate">
                                ...
                                <c:forEach items="${freelancer.academicList}" var="academic" varStatus="status">
                                    <div class="education-box item-box">
                                        ...
                                        <div class="input-month-group-horizontal">
                                            ...
                                            <div class="input-education-date">
                                                <label>졸업연월</label>
                                                <input name="educationList[${status.index}].graduateDate"
                                                       type="month"
                                                       value="<%= graduateMonth %>"/>
                                            </div>
                                        </div>
                            ...
                            <c:otherwise>
                                <div class="education-box item-box">
                                    ...
                                    <div class="input input-major input-with-icon academic-major-field">
                                        ...
                                        <input type="text" name="educationList[0].academicMajor" id="academicMajor_0"
                                               placeholder="전공"/>
                                    </div>
                    ...
                    <button type="button" class="button add-education-btn" id="education_addbutton">+ 학력 추가</button>
                </div>
                        ...
                        <c:choose>
                                ...
                                <c:forEach items="${careerList}" var="career" varStatus="status">
                                    <div class="career-box item-box">
                                        ...
                                        <div class="career-row">
                                            ...
                                            <input type="text" name="careerList[${status.index}].salary"
                                                   placeholder="연봉"
                                                   value="${career.salary}"
                            ...
                            <c:otherwise>
                                <div class="item-box career-box">
                                    <button type="button" class="button buttonDeleteField">X</button>
                                    <div class="career-row">
                                        <input type="text" name="careerList[0].companyName" id="companyName_0"
                                               placeholder="회사명" required="">
                                        <input type="text" name="careerList[0].departmentName" id="departmentName_0"
                                               placeholder="부서명">
                                        <span>입사<span class="star">*</span></span>
                                    ...
                                    <div class="career-row">
                                        <input type="text" name="careerList[0].position" id="position_0"
                                               placeholder="직급/직책">
                                        <input type="text" name="careerList[0].jobTitle" id="jobTitle_0"
                                               placeholder="담당직무">
                                        <input type="text" name="careerList[0].salary" id="salary_0" placeholder="연봉"
                                               oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                        <span>만 원</span>
                                    </div>
                                    <span>담당업무</span>
                                    <textarea name="careerList[0].jobDescription" id="jobDescription_0"
                                              placeholder="담당하신 업무와 성과에 대해 간단하게 적어주세요." required=""></textarea>
                                </div>
                            </c:otherwise>
                        </c:choose>
                    </div>
                    <button type="button" class="button add-career-btn">+ 경력 추가</button>
                </div>
                <div class="form form-group formCertificate">
                    <label>자격증</label>
                            ...
                            <c:otherwise>
                                <div class="item-box license-box">
                                    <div class="license-row">
                                        ...
                                        <div class="input input-certificate-name is-label">
                                            <label>자격증 명 <span class="star">*</span></label>
                                            <input type="text" name="licenseList[0].name" id="licenseName_0"
                                                   placeholder="자격증명" required="" maxlength="50">
                                        </div>
                                        <div class="input input-certificate-agency is-label">
                                            <label>점수 / 급</label>
                                            <input type="text" name="licenseList[0].licenseGrade" id="licenseGrade_0"
                                                   placeholder="점수 / 급" maxlength="50">
                                        </div>
                                        <div class="input input-certificate-agency is-label">
                                            <label>발행처</label>
                                            <input type="text" name="licenseList[0].licenseAgency" id="licenseAgency_0"
                                                   placeholder="발행처" maxlength="50">
                                        </div>
                                        <div class="input input-certificate-term is-label">
                                            <label>취득월</label>
                    ...
                    <button type="button" class="button add-license-btn">+ 자격증 추가</button>
                </div>
                ...
                <div class="file-upload-section">
                    ...
                    <div class="file-upload-buttons">
                        <button id="add-outer-url" type="button" class="button">외부 URL 추가</button>
                        <button id="add-attachment-file" type="button" class="button">내 PC에서 파일 첨부</button>
                    </div>
                    <table>
                        <tbody>
                        <c:if test="${freelancer.externalUrlList ne null}">
                            <c:forEach var="externalUrl" items="${freelancer.externalUrlList}" varStatus="status">
                                <tr class="url-section">
                                    ...
                                    <td>
                                        <button type="button" class="delete-tr button">X</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </c:if>
                ...
                <div class="submit-wrap">
                    <button type="submit" class="save-btn button">저장</button>
                </div>
            </form>
        </section>
    </main>

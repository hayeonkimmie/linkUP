...
public class LWYProject {
     ...
     */
    public LWYProject(Integer projectId, String projectName, String createdDate, Integer totalAmount, String projectStatus, String projectManager, String settleStatus) {
     ...
     * @param settleStatus 정산 상태
     */
    public LWYProject(String projectName, String projectDescription, String createdDate, String projectEndDate,
